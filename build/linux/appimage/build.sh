...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  ...
  # workaround that enforces x86 ARCH for pkg2appimage having /__w/Gringo2/VScodium/build/linux/appimage/Gringo2/VScodium.AppDir/usr/share/codium/resources/app/node_modules/rc/index.js is of architecture armhf
  export ARCH=x86_64
