...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  ...
  # add update's url
  sed -i 's/generate_type2_appimage/generate_type2_appimage -u "gh-releases-zsync|codesphere|codesphere|latest|*.AppImage.zsync"/' pkg2appimage.AppDir/AppRun
  ...
  # workaround that enforces x86 ARCH for pkg2appimage having /__w/Gringo2/codesphere/build/linux/appimage/Gringo2/codesphere.AppDir/usr/share/codium/resources/app/node_modules/rc/index.js is of architecture armhf
  export ARCH=x86_64
