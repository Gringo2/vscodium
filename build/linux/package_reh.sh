...
if [[ "${VSCODE_ARCH}" == "x64" ]]; then
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="Gringo2/VScodium-linux-build-agent:focal-devtoolset-x64"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="Gringo2/VScodium-linux-build-agent:focal-devtoolset-arm64"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="Gringo2/VScodium-linux-build-agent:focal-devtoolset-armhf"

  export VSCODE_SKIP_SYSROOT=1
  export USE_GNUPP2A=1
elif [[ "${VSCODE_ARCH}" == "ppc64le" ]]; then
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="Gringo2/VScodium-linux-build-agent:focal-devtoolset-ppc64le"
  ...
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="Gringo2/VScodium-linux-build-agent:focal-devtoolset-riscv64"

  export VSCODE_SKIP_SETUPENV=1
  export VSCODE_NODEJS_SITE='https://unofficial-builds.nodejs.org'
elif [[ "${VSCODE_ARCH}" == "loong64" ]]; then
  NODE_VERSION="20.16.0"
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="Gringo2/VScodium-linux-build-agent:beige-devtoolset-loong64"

  export VSCODE_SKIP_SETUPENV=1
  export VSCODE_NODEJS_SITE='https://unofficial-builds.nodejs.org'
elif [[ "${VSCODE_ARCH}" == "s390x" ]]; then
  VSCODE_REMOTE_DEPENDENCIES_CONTAINER_NAME="Gringo2/VScodium-linux-build-agent:focal-devtoolset-s390x"
  VSCODE_SYSROOT_PREFIX="-glibc-${GLIBC_VERSION}"
